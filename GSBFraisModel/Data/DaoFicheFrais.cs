...
namespace GSBFraisModel.Data
{
    public class DaoFicheFrais
    {
        ...
        {
            string montantValide = theFicheFrais.MontantValide.ToString();
            string query = "FicheFrais SET nbJustificatifs='" + theFicheFrais.NbJustificatifs
                + "',montantValide =" + montantValide.Replace(",", ".")
        ...
        public FicheFrais SelectById(string idVisiteur, string mois)
        {
            ...
            return new FicheFrais(unVisiteur, (string)result["mois"], (decimal)result["montantValide"], (int)result["nbJustificatifs"], (DateTime)result["dateModif"], unEtat);
        }
