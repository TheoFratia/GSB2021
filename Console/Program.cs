...
namespace ConsoleTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            DaoEtat unEtat = new DaoEtat(unDbal);
            DaoFicheFrais unDaoFicheFrais = new DaoFicheFrais(unDbal, unDaoVisiteur, unEtat);
            List<string> uneListeMois = unDaoFicheFrais.SelectListMois();
            foreach(string r in uneListeMois)
            {
                Console.WriteLine(r);
            }
            Console.Read();
